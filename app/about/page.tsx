...
import { ArrowLeft, Heart, Lightbulb, Users, Briefcase, GraduationCap } from 'lucide-react'
          ...
          <div className="relative flex flex-col items-center">
            ...
            {[
              ...
              },
              {
                ...
                description: 'SES企業にて、SES→受託→自社開発に従事。Laravel、Nextを用いたシステムの開発や、既存システムの保守・改善を担当',
              },
              {
                type: 'education',
                title: 'プログラミングスクール受講',
              ...
              },
              {
                ...
                company: '情報系の大学',
                period: '2015年 - 2019年',
                description: '学生時代はプログラミング、動画制作、アニメーション制作など諸々の分野を学びましたが、クリエイティブな思考とITスキルの基礎はそんなに身につきませんでした。',
              },
            ].map((exp, index) => {
